...
export const TEST_RULES_QUICK: RulesConfig = {
  ...
  treasure: { amount: 100 },
  donation: { amount: 20 },
  zakat: { enabled: true, rate: 0.025, nisabKounouz: 1000, cycleRounds: 6, eligibleAssetTypes: ["money"] },
  rewards: { correct: 50, partial: 25, incorrect: 0, masteryMultiplier: 2 },
  scoring: { moneyWeight: 1, heritageWeight: 1, hassanatWeight: 0 },
  service: { insufficient: "cap_to_balance" },
