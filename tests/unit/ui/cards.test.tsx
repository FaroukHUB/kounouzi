...
describe("carte question (rendu statique)", () => {
  ...
  const render = (card: Parameters<typeof QuestionCard>[0]["card"]) => renderToStaticMarkup(<QuestionCard state={asked.state} profiles={profiles} card={card} narrator={narrator} reduced={true} onUpdate={() => {}} onSubmit={() => {}} />);
