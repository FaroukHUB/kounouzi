...
export const INTERACTION_KINDS = ["question", "duel", "family_challenge", "establishment", "service", "hassanat", "heritage_visit", "event", "management", "solidarity", "treasure", "halt", "donation"] as const;
