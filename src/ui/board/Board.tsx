...
export function Board({ board, highlightedCell, arrivalCell, previewPath, pawns, center, holdings = [], players = [], profiles = [] }: BoardProps) {
  ...
  return (
    <div className="bg-wood relative aspect-square w-full max-w-[min(94vw,80vh)] select-none rounded-[2.2rem] p-[2.2%] shadow-[0_30px_70px_-30px_rgba(60,35,10,0.75),inset_0_2px_0_rgba(255,255,255,0.25)]" data-testid="board">
      ...
      <div
        ...
        style={{
          ...
          gridTemplateRows: `repeat(${g}, minmax(0, 1fr))`,
      ...
      >
        ...
        <div className="relative flex items-center justify-center" style={{ gridRow: `2 / ${g}`, gridColumn: `2 / ${g}` }}>
          {center}
        </div>
      </div>
