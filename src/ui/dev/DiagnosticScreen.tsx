    ...
    <main className="mx-auto flex w-full max-w-4xl flex-col gap-6 p-6" data-testid="diagnostic-screen">
      ...
      <section className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          ["Dons", `${report.counts.donations} (caisse ${report.counts.donationsToFund})`],
          ["Zakat al-Māl", `${report.counts.zakatPayments} versements / ${report.counts.zakatKounouz}`],
          ["Années / Caisse Masākīn", `${report.counts.yearsCompleted} / ${report.counts.masakinFund}`],
